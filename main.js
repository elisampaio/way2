  ...
  if (localStorage.getItem("records") == null) {
    ...
    records.forEach(function (record) {
      let newRecord = $(`<div class="newRecord">
        <p class="q-date">${record.date}</p>
        <p><span>${record.day}</span></p>
        <p>❤️ <span>${record.feel}</span></p>
        <p>🌙 <span>${record.sleep}</span></p>
        <p>⚽ <span>${record.exercise}</span></p>
        <p><span>${record.social}</span></p>
        </div>`);
      $("#records_day").append(newRecord);

      // <p class="q-date">${record.date}</p>
      // <p><img src="icons/1.png" class="records-icon"><span>${record.day}</span></p>
      // <p><img src="icons/2.png" class="records-icon"><span>${record.feel}</span></p>
      // <p><img src="icons/3.png" class="records-icon"><span>${record.sleep}</span></p>
      // <p><img src="icons/4.png" class="records-icon"><span>${record.exercise}</span></p>
      // <p><img src="icons/5.png" class="records-icon"><span>${record.social}</span></p>
      // </div>`);
    });
  }
}
